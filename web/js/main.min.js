...
define('text!templates/issues-list-item.html',[],function () { return '<td class="issues_table_item_number"><%= number %></td>\r\n<td class="issues_table_item_title"><%= title %></td>\r\n<td class="issues_table_item_date"><%= created_at %></td>';});

define('views/issues-list-item-view',[
    'app',
...
define('models/search-form-model',[
    'marionette'
], function () {
...
define('models/issues-list-item-model',[
    'marionette'
], function () {
    return Backbone.Model.extend(); 
});
define('collections/issues-list-collection',[
...
define('text!templates/issue.html',[],function () { return '<li class="issue_username">User name: <%= user.login %></li>\r\n<li class="issue_picture">User picture: <img src="<%= user.avatar_url %>" alt="User picture"></li>\r\n<li class="issue_link"><a href="<%= user.url %>">User profile link</a></li>\r\n';});

define('views/issue-view',[
    'app',
